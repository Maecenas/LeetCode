...
Ashe be in poisoned condition. Now, given the Teemo's attacking ascending
...
and his poisoning time duration per attacking are non-negative integers,
which won't exceed 10,000,000.
*/

class _495_TeemoAttacking {
